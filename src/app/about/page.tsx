        ...
        <div className="space-y-16">
          ...
          <section>
            ...
            <div className="space-y-4 text-muted leading-relaxed">
              <p>
                O <strong className="text-ink">Cat Café</strong> nasceu do amor pelos gatos e da vontade de
          ...
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {servicos.map((servico, i) => (
                <div
                  key={i}
                  className="px-4 py-3 rounded-xl border border-pink/20 bg-rose-light text-center text-sm text-ink hover:bg-rose-light hover:border-pink/40 transition-colors"
                >
                  {servico}
                </div>
              ))}
          ...
          <section>
            ...
            <div className="p-6 rounded-2xl border border-pink/20 bg-rose-light">
              <p className="text-muted leading-relaxed">
                ...
                bebidas especiais e comidas artesanais. Também oferecemos <strong className="text-ink">planos de
                assinatura</strong> para clientes frequentes, <strong className="text-ink">eventos privados</strong> e
