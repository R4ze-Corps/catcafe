      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-16">
          ...
          <section>
            ...
            <div className="space-y-4 text-rose leading-relaxed">
              <p>
              ...
              <div className="rounded-2xl border border-pink/20 bg-ink-light p-6">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {servicos.map((servico, i) => (
                <div
                  key={i}
                  className="px-4 py-3 rounded-xl border border-pink/20 bg-ink-light text-center text-sm text-pink hover:bg-ink-light hover:border-pink/40 transition-colors"
                >
                  {servico}
                </div>
              ))}
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-6 rounded-2xl border border-pink/20 bg-ink-light">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                <div
                  key={i}
                  className="p-6 rounded-2xl border border-pink/20 bg-ink-light text-center hover:bg-ink-light transition-colors"
                >
