      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-3xl mx-auto">
          <Image
            ...
            priority
          />
          <h1 className="text-5xl md:text-7xl font-bold tracking-wider text-rose mb-6">
            CAT CAFÉ
          </h1>
          <p className="text-xl md:text-2xl text-rose-light mb-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              href="/contact"
              className="px-8 py-3 border border-rose text-rose-light rounded-full hover:bg-rose/20 transition-colors tracking-wider uppercase text-sm"
            >
              Faça sua Reserva
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            >
              ...
              <h3 className="text-ink text-lg font-semibold mb-2">{item.title}</h3>
      ...
      <section className="py-20 px-4 bg-rose border-t border-pink/20">
        <div className="max-w-xl mx-auto text-center">
          ...
          <div className="rounded-2xl border border-pink/20 bg-rose-light p-8 hover:bg-rose-light hover:border-pink/40 transition-all">
            ...
            <h3 className="text-ink font-semibold text-xl mb-3">{events[0].title}</h3>
            <p className="text-muted text-sm leading-relaxed">{events[0].desc}</p>
          </div>
          <Link
            href="/events"
            className="mt-8 inline-block px-8 py-3 bg-pink text-rose font-semibold rounded-full hover:bg-pink-light transition-colors uppercase text-sm tracking-wider"
          >
