  ...
  return (
    <>
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-pink/80 via-pink/40 to-ink" />
        ...
        <div className="relative z-10 text-center px-4 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/events"
              className="px-8 py-3 bg-ink text-pink font-semibold rounded-full hover:bg-ink-light transition-colors tracking-wider uppercase text-sm"
            >
              Próximos Eventos
            </Link>
            <Link
              href="/contact"
              className="px-8 py-3 border border-ink text-pink-light rounded-full hover:bg-ink/20 transition-colors tracking-wider uppercase text-sm"
            >
              Faça sua Reserva
            </Link>
          </div>
      ...
      <section className="py-20 px-4 bg-ink">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div
              key={i}
              className="group p-8 rounded-2xl border border-pink/20 bg-ink-light hover:bg-ink-light hover:border-pink/40 transition-all text-center"
            >
              ...
              <p className="text-rose text-sm leading-relaxed">{item.desc}</p>
            </div>
          ))}
        </div>
      </section>

      <section className="py-20 px-4 bg-ink border-t border-pink/20">
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-pink mb-10">Próximo Evento</h2>
          <div className="rounded-2xl border border-pink/20 bg-ink-light p-8 hover:bg-ink-light hover:border-pink/40 transition-all">
            ...
            <p className="text-rose text-sm leading-relaxed">{events[0].desc}</p>
          </div>
          <Link
            href="/events"
            className="mt-8 inline-block px-8 py-3 bg-pink text-pink font-semibold rounded-full hover:bg-pink-light transition-colors uppercase text-sm tracking-wider"
          >
