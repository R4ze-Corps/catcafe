          ...
          {[
            {
              ...
              title: "Músicas",
              desc: "Nosso café é lar de gatinhos. aceitamos a entrada de pets em nosso estabelecimentos. Mas todos precisam estar vacinados e castrados.",
            },
            {
              icon: (
                <svg
            ...
            >
              ...
              <h3 className="text-pink text-lg font-semibold mb-2">
                {item.title}
              </h3>
